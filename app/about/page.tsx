...
const page = () => {
    ...
    return (
        <div>
            <section className="overflow-hidden bg-white text-black pb-12 pt-20 lg:pb-[90px] lg:pt-[120px] dark:bg-dark">
                        ...
                        <div className="w-full px-4 lg:w-1/2 xl:w-5/12">
                            <div className="mt-10 lg:mt-0">
                                ...
                                <a
                                    ...
                                    className="inline-flex items-center justify-center rounded-md border border-transparent bg-primary px-7 py
